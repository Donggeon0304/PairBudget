function parseSegmented(rawText) {
    ...
    if (cleanedSegments.length === 0)
        return null;
    // 여러 세그먼트가 남았다면 일반적으로 맨 마지막 세그먼트가 가맹점/송금자
    return cleanedSegments[cleanedSegments.length - 1].substring(0, 20);
}
var cases = [
    '카카오뱅크 입금 1원\n명동건 → 입출금통장(1893)',
    '입출금 알림 농협 출금 1원\n10/12 14:00\n123-1234-1234-73\n명동건\n잔액 100,000원',
...
cases.forEach(function (c, i) {
    console.log("Case ".concat(i + 1, ": ").concat(parseSegmented(c)));
});
